...
const amenities = [
  ...
  },
  {
    ...
    title: 'Recepcija',
    description: 'Profesionalni tim na usluzi radnim danom od 8-18h. Primanje paketa i gostiju s osmjehom.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-8 h-8">
  ...
  },
  {
    ...
    title: 'Parking',
    description: 'Mogućnost parkirnog mjesta uz objekt. Lako dolazite, lako odlazite.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-8 h-8">
        <path d="M6.75 9v6m10.5-6v6M4.5 10.5v3M19.5 10.5v3M2.25 12h1.5m16.5 0h1.5M6.75 7.5h.75a.75.75 0 01.75.75v7.5a.75.75 0 01-.75.75h-.75a.75.75 0 01-.75-.75v-7.5a.75.75 0 01.75-.75zm9.75 0h.75a.75.75 0 01.75.75v7.5a.75.75 0 01-.75.75h-.75a.75.75 0 01-.75-.75v-7.5a.75.75 0 01.75-.75zM8.25 12h7.5" />
      </svg>
    ),
    title: 'Teretana',
    description: 'Teretana u prizemlju objekta. Trening prije, tijekom ili nakon radnog dana.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-8 h-8">
    ...
    title: 'Terasa',
    description: 'Vanjska terasa za predah, neformalne sastanke i rad na otvorenom.',
  },
];
