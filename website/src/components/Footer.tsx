      ...
      >
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8">
          ...
          <div className="col-span-2 lg:col-span-4">
            ...
            <p className="leading-relaxed mb-6" style={{ maxWidth: '280px', color: '#a3a3a3' }}>
              Premium servisani uredi u srcu Splita. Dizajnirani za uspjeh.
            </p>
            <div className="space-y-2">
              <p className="text-sm" style={{ color: '#737373' }}>Ulica Domovinskog rata 61</p>
              <p className="text-sm" style={{ color: '#737373' }}>21000 Split, Hrvatska</p>
              <a href="tel:+38521123456" className="block text-white font-semibold hover:text-coral transition-colors">
                +385 21 123 456
              </a>
              <a href="mailto:info@habu.hr" className="block text-white font-semibold hover:text-coral transition-colors">
                info@habu.hr
              </a>
            </div>
          </div>
          ...
          <div className="col-span-2 lg:col-span-4 lg:col-start-9">
            ...
            <p className="text-sm mb-4" style={{ color: '#a3a3a3' }}>
              Budite u toku s novostima i posebnim ponudama.
            </p>
            <form className="flex" onSubmit={(e) => e.preventDefault()}>
              <input
                type="email"
                placeholder="Vaš email"
                className="flex-1 px-4 py-3 text-white text-sm transition-colors"
                style={{ backgroundColor: '#171717', border: '1px solid #262626' }}
                onFocus={(e) => e.currentTarget.style.borderColor = '#F2594B'}
                onBlur={(e) => e.currentTarget.style.borderColor = '#262626'}
              />
              <button
                type="submit"
                className="px-6 py-3 bg-coral text-white font-semibold text-sm hover:bg-white hover:text-black transition-colors"
              >
                Prijavi se
              </button>
            </form>
        ...
        >
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            <p className="text-sm" style={{ color: '#737373' }}>
              © {currentYear} Habu. Sva prava pridržana.
            </p>
